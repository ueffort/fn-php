...
class FN_platform_qqoauth extends FN_server_oauth{
    const VERSION = "2.0";
    ...
    public function getUserInfo(){
        ...
        $this->user_nick = $info['nickname'];
        $this->user_avatar = empty($info['figureurl_qq_2']) ? $info['figureurl_qq_1'] : $info['figureurl_qq_2'];
